...
const translations = {
  fr: {
    ...
    "contact.captcha": "Question anti-spam",
    "contact.captchaPlaceholder": "Votre réponse",
    "contact.send": "Envoyer",
    "contact.sending": "Envoi en cours...",
    "contact.requiredFields": "Merci de renseigner tous les champs.",
  ...
  en: {
    ...
    "contact.captcha": "Anti-spam question",
    "contact.captchaPlaceholder": "Your answer",
    "contact.send": "Send",
    "contact.sending": "Sending...",
    "contact.requiredFields": "Please fill in every field.",
